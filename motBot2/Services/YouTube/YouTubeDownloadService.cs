...
namespace motBot2.Services.YouTube
{
    public class YouTubeDownloadService
    {
        ...
        private static Process StartYoutubeDl(string arguments)
        {
            string location = Environment.CurrentDirectory+ @"\Binaries\youtube-dl.exe";
            var youtubeDlStartupInfo = new ProcessStartInfo
            {
                ...
                CreateNoWindow = true,
                //FileName = "youtube-dl",
                //FileName = @"C:\Users\Administrator\Documents\Visual Studio 2017\Projects\MotBot1\MotBot1\bin\Debug\Binaries\youtube-dl.exe",
                FileName = location,
                Arguments = arguments
            };
